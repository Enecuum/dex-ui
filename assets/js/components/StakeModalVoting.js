...
class StakeModalVoting extends React.Component {
    constructor(props) {
      super(props);
...
const WStakeModalVoting = connect(mapStoreToProps(components.VOTING), mapDispatchToProps(components.VOTING))(withTranslation()(StakeModalVoting));

export default WStakeModalVoting;
