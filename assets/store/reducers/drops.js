...
const actions = actionPack.drops;
...
export default function dropsReducer (state = initialState.drops, action) {
    switch (action.type) {
        case actions.DROPS_UPDATE_STAKE_DATA:
            return {
                ...state,
                stakeData : assignStakeDataProperty(state, 'stakeData', action)
            };        
        case actions.DROPS_UPDATE_EXPANDED_ROW:
            return {
                ...state,
                expandedRow : action.payload
            };
        case actions.DROPS_UPDATE_FARMS_LIST:
            return {
                ...state,
                farmsList : action.payload
            };        
        case actions.DROPS_UPDATE_MANAGED_FARM_DATA:
            return {
                ...state,
                managedFarmData : action.payload
            };            
        case actions.DROPS_UPDATE_SORT_TYPE:
            return {
                ...state,
                sortType : action.payload
            };
        case actions.DROPS_UPDATE_SHOW_STAKE_MODAL:
            return {
                ...state,
                showStakeModal : action.payload
            };
        case actions.DROPS_UPDATE_MAIN_TOKEN_AMOUNT:
            return {
                ...state,
                mainTokenAmount : action.payload
            };
        case actions.DROPS_UPDATE_MAIN_TOKEN_DECIMALS:
            return {
                ...state,
                mainTokenDecimals : action.payload
            };
        case actions.DROPS_UPDATE_MAIN_TOKEN_FEE:
            return {
                ...state,
                mainTokenFee : action.payload
            };
        case actions.DROPS_UPDATE_PRICELIST:
            return {
                ...state,
                pricelist : action.payload
            };
        case actions.DROPS_UPDATE_CURRENT_ACTION:
            return {
                ...state,
