...
export default function votingReducer (state = initialState.voting, action) {
    switch (action.type) {
        case actions.VOTING_UPDATE_STAKE_DATA:
            return {
                ...state,
                stakeData : assignStakeDataProperty(state, 'stakeData', action)
            };        
        case actions.VOTING_UPDATE_EXPANDED_ROW:
            return {
                ...state,
                expandedRow : action.payload
            };
        case actions.VOTING_UPDATE_FARMS_LIST:
            return {
                ...state,
                farmsList : action.payload
            };        
        case actions.VOTING_UPDATE_MANAGED_FARM_DATA:
            return {
                ...state,
                managedFarmData : action.payload
            };            
        case actions.VOTING_UPDATE_SORT_TYPE:
            return {
                ...state,
                sortType : action.payload
            };
        case actions.VOTING_UPDATE_SHOW_STAKE_MODAL:
            return {
                ...state,
                showStakeModal : action.payload
            };
        case actions.VOTING_UPDATE_MAIN_TOKEN_AMOUNT:
            return {
                ...state,
                mainTokenAmount : action.payload
            };
        case actions.VOTING_UPDATE_MAIN_TOKEN_DECIMALS:
            return {
                ...state,
                mainTokenDecimals : action.payload
            };
        case actions.VOTING_UPDATE_MAIN_TOKEN_FEE:
            return {
                ...state,
                mainTokenFee : action.payload
            };
        case actions.VOTING_UPDATE_PRICELIST:
            return {
                ...state,
                pricelist : action.payload
            };
        case actions.VOTING_UPDATE_CURRENT_ACTION:
            return {
                ...state,
